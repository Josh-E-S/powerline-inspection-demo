...
def sanity_check(fp32_path: Path, int8_path: Path, imgsz: int, n: int = 8):
    ...
    s32 = ort.InferenceSession(
        str(fp32_path), providers=["CPUExecutionProvider"]
    )
    s8 = ort.InferenceSession(
